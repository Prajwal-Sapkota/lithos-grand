...
const Hero = () => {
    ...
    const { hero, treatments } = wellnessData;
    ...
    return (
        <section className="relative h-[60vh] sm:h-[70vh] md:h-[80vh] lg:h-[85vh] w-full overflow-hidden bg-[#2C2C2C]">
            ...
            <div className="absolute inset-0">
                ...
                />
                {/* Using same black overlays as culinary section */}
            ...
            {/* Treatments/Services Crawler at Bottom */}
            <div className="absolute bottom-0 left-0 right-0 z-20 bg-black/40 backdrop-blur-md border-t border-white/10">
                <div className="overflow-hidden py-3 sm:py-4 md:py-5">
                    <div className="flex animate-marquee whitespace-nowrap">
                        {/* Duplicate treatments for seamless loop */}
                        {[...treatments, ...treatments, ...treatments].map((item, index) => (
                            <span
                                key={`${item.id}-${index}`}
                ...
                {/* Gradient fades on edges - smaller on mobile */}
